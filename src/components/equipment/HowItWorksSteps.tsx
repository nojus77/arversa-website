...
import { Phone, FileText, HardHat } from "lucide-react";
...
const STEPS: Step[] = [
  {
    ...
    title: "Susisiekite",
    description:
      "Paskambinkite arba parašykite mums. Papasakokite, kokią techniką reikia ir kokiems darbams.",
  },
  {
    number: 2,
    icon: FileText,
    ...
    description:
      "Per 2 valandas gausite konkretų pasiūlymą su kaina ir terminais. Jokių paslėptų mokesčių.",
  },
  {
    number: 3,
    icon: HardHat,
    title: "Pradedame darbus",
    description:
      "Sutarta data pristatomame techniką su patyrusiu vairuotoju. Jūs prižiūrite — mes dirbame.",
  },
];

export function HowItWorksSteps(): React.ReactElement {
  return (
